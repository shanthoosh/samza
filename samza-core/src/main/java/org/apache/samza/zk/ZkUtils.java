...
public class ZkUtils {
  ...
  public Map<String, LocationId> readProcessorLocality() {
    ...
    LOG.info("Read processorLocality: {} from zookeeper.", processorLocality);
  ...
  public Map<TaskName, LocationId> readTaskLocality() {
    ...
    for (String taskName : taskNames) {
      ...
      LOG.info("Read locationId: {} for taskPath: {} from zookeeper.", locationId, completeZKTaskNodePath);
