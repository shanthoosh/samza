...
/**
 *
 * SetTaskPartitionMapping is a {@link CoordinatorStreamMessage} used internally
 ...
 * </pre>
 *
 * This is used to store the task to partition assignments for only non-broadcast, input streams of the samza job.
 */
