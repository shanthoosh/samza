...
public class StorageRecovery extends CommandLine {
  ...
  private void getContainerModels() {
    ...
    JobModel jobModel = JobModelManager.apply(coordinatorStreamManager.getConfig(), changelogStreamManager.readPartitionMapping(), coordinatorStreamManager, metricsRegistryMap).jobModel();
