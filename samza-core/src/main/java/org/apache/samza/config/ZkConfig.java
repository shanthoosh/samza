...
public class ZkConfig extends MapConfig {
  ...
  public static final String CONFIG_COORDINATOR_ZK_BASE_PATH = "job.coordinator.zk.base.path";
  public static final String CONFIG_ZK_STORE_BASE_PATH = "job.zk.store.base.path";
  ...
  public String getZkCoordinatorBasePath() {
    return get(CONFIG_COORDINATOR_ZK_BASE_PATH);
  }

  public String getStoreBasePath() {
    return get(CONFIG_ZK_STORE_BASE_PATH);
  }
}
